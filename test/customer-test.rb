...
class TestCustomer < Minitest::Test
  ...
  def test_successful_transactions_method_returns_successful_transactions
    ...
    assert_equal 6, customer.successful_transactions.count
  ...
  def test_successful_invoices_method_returns_successful_invoices
    ...
    assert_equal 6, customer.successful_invoices.count
  ...
  def test_successful_merchant_ids_method
    ...
    customer = Customer.new("1",
                            ...
                            "2012-03-27 14:54:09 UTC",
                            c_repo)
    assert_equal ["26", "26", "26", "50", "78", "33"], customer.successful_merchant_ids
  end
  ...
  def test_count_merchant_ids_method
    ...
    assert_equal "26", customer.count_merchant_ids.first[0]
  end

  def test_sort_merchant_ids_method
    engine = SalesEngine.new("./data/fixtures")
    engine.startup
    c_repo = engine.customer_repository
    customer = Customer.new("1",
                            ...
                            "2012-03-27 14:54:09 UTC",
                            c_repo)
    assert_equal "26", customer.sort_merchant_ids.first[0]
  end

  def test_favorite_merchant_method_returns_favorite_merchant
    engine = SalesEngine.new("./data/fixtures")
    engine.startup
    c_repo = engine.customer_repository
    customer = Customer.new("1",
